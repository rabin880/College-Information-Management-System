        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-2" href="galleryevents.php">Gallery & Events</a>
                    </li>
                    <li class="nav-item">
...
<section id="recent-notices" class="container mt-5">
    <div class="d-flex flex-column align-items-center text-center">
        <h1 class="section-title mt-5 pb-5">All Gallery And Events</h1>
    </div>

    <div class="row mt-4">
        <?php
        // Fetch all gallery images and titles
        $notices = $conn->query("SELECT title, image FROM gallery ORDER BY created_at DESC");

        // Check if records exist
        if ($notices->num_rows > 0):
            while ($row = $notices->fetch_assoc()):
                $filePath = "gallerypics/" . htmlspecialchars($row['image']); // File path
        ?>
        <div class="col-md-4 mb-4">  <!-- Adjusted to col-md-4 for better alignment -->
            <div class="card h-100 shadow-sm">
                <img src="<?= $filePath ?>" class="card-img-top img-fluid" alt="<?= htmlspecialchars($row['title']) ?>" style="object-fit: cover; height: 250px;">
        ...
        <?php endwhile; else: ?>
        <p class="text-center">No gallery and events available.</p>
        <?php endif; ?>
    </div>
</section>
